...
final class L10n: @unchecked Sendable {
    ...
    /// Discovered dynamically — drop a new `<code>.json` into `Tearoff/Resources/Locales/` and
...
extension Notification.Name {
    static let localeDidChange = Notification.Name("io.github.zcyisiee.Tearoff.localeDidChange")
}
