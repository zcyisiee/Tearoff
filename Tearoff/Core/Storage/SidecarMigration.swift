...
/// One-time migration from YAML front matter to the `.tearoff/meta.json` sidecar.
...
enum SidecarMigration {
    ...
    private static func run() throws {
        ...
        // --- Active notes ---
        let notePaths = collectMarkdownFiles(in: rootURL, excluding: [
            trashURL,
            rootURL.appendingPathComponent(FileStorage.sidecarDirectoryName),
            rootURL.appendingPathComponent(FileStorage.legacySidecarDirectoryName),
        ])
