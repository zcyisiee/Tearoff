...
- 🔘 एज-टॉगल मोड — एज छूकर पैनल खोलें और टेक्स्ट आगे-पीछे कॉपी करते समय इसे खुला रखें, बंद करने के लिए फिर से छुएं (⌘P की ज़रूरत नहीं); ऑटो-हाइड डिफ़ॉल्ट रहता है
- 📐 मल्टी-मॉनिटर सपोर्ट, कॉन्फ़िगरेबल लेफ्ट या राइट एज — सिर्फ़ बाहरी स्क्रीन एज ट्रिगर करता है, ताकि डिस्प्ले के बीच माउस घुमाने पर यह गलती से न खुले
...
- ▫️ कस्टम टास्क-चेकबॉक्स सिंबल्स — सेटिंग्स में `- [ ]`/`- [x]` आइटम के लिए शेप चुनें (Square, Circle, Diamond, Shield, Triangle, Star, Hexagon, Heart); सिर्फ़ डिस्प्ले-लेयर, नोट्स मानक Markdown रहते हैं
