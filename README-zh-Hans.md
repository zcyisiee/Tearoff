...
- 🔘 边缘切换模式——触碰边缘打开面板并在你来回复制文本时保持开启，再次触碰关闭（无需 ⌘P）；默认仍为自动隐藏
- 📐 多显示器支持，可配置左边缘或右边缘——仅外缘触发，因此在显示器之间移动鼠标不会误触
...
- ▫️ 自定义任务复选框符号——在设置中为 `- [ ]`/`- [x]` 任务项选择形状（方形、圆形、菱形、盾形、三角形、星形、六边形、心形）；仅显示层，笔记保持标准 Markdown
- 📋 围栏代码块一键复制按钮
